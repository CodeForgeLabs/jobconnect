...
const file_job_v1_job_proto_rawDesc = "" +
	...
	"\x06closed\x18\x01 \x01(\bR\x06closed\"\x84\x04\n" +
	...
	"\x16closed_at_unix_seconds\x18\x0f \x01(\x03R\x13closedAtUnixSeconds2\x98\x03\n" +
	"\n" +
	"JobService\x12@\n" +
...
var file_job_v1_job_proto_goTypes = []any{
	...
	(*UpdateJobRequest)(nil),     // 10: job.v1.UpdateJobRequest
	(*UpdateJobResponse)(nil),    // 11: job.v1.UpdateJobResponse
	(*JobAttachment)(nil),        // 12: job.v1.JobAttachment
	(*Job)(nil),                  // 13: job.v1.Job
}
var file_job_v1_job_proto_depIdxs = []int32{
	12, // 0: job.v1.CreateJobRequest.attachments:type_name -> job.v1.JobAttachment
	13, // 1: job.v1.CreateJobResponse.job:type_name -> job.v1.Job
	13, // 2: job.v1.GetJobResponse.job:type_name -> job.v1.Job
	13, // 3: job.v1.ListMyJobsResponse.jobs:type_name -> job.v1.Job
	13, // 4: job.v1.ListOpenJobsResponse.jobs:type_name -> job.v1.Job
	12, // 5: job.v1.UpdateJobRequest.attachments:type_name -> job.v1.JobAttachment
	13, // 6: job.v1.UpdateJobResponse.job:type_name -> job.v1.Job
	12, // 7: job.v1.Job.attachments:type_name -> job.v1.JobAttachment
	0,  // 8: job.v1.JobService.CreateJob:input_type -> job.v1.CreateJobRequest
	2,  // 9: job.v1.JobService.GetJob:input_type -> job.v1.GetJobRequest
	10, // 10: job.v1.JobService.UpdateJob:input_type -> job.v1.UpdateJobRequest
	4,  // 11: job.v1.JobService.ListMyJobs:input_type -> job.v1.ListMyJobsRequest
	6,  // 12: job.v1.JobService.ListOpenJobs:input_type -> job.v1.ListOpenJobsRequest
	8,  // 13: job.v1.JobService.CloseJob:input_type -> job.v1.CloseJobRequest
	1,  // 14: job.v1.JobService.CreateJob:output_type -> job.v1.CreateJobResponse
	3,  // 15: job.v1.JobService.GetJob:output_type -> job.v1.GetJobResponse
	11, // 16: job.v1.JobService.UpdateJob:output_type -> job.v1.UpdateJobResponse
	5,  // 17: job.v1.JobService.ListMyJobs:output_type -> job.v1.ListMyJobsResponse
	7,  // 18: job.v1.JobService.ListOpenJobs:output_type -> job.v1.ListOpenJobsResponse
	9,  // 19: job.v1.JobService.CloseJob:output_type -> job.v1.CloseJobResponse
...
func file_job_v1_job_proto_init() {
	...
	file_job_v1_job_proto_msgTypes[10].OneofWrappers = []any{}
	type x struct{}
