...
type CompensationChange struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	NewHourlyRate float64                `protobuf:"fixed64,1,opt,name=new_hourly_rate,json=newHourlyRate,proto3" json:"new_hourly_rate,omitempty"`
	NewFixedTotal float64                `protobuf:"fixed64,2,opt,name=new_fixed_total,json=newFixedTotal,proto3" json:"new_fixed_total,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CompensationChange) GetNewHourlyRate() float64 {
	if x != nil {
		return x.NewHourlyRate
	}
	return 0
}

func (x *CompensationChange) GetNewFixedTotal() float64 {
	if x != nil {
		return x.NewFixedTotal
	}
	return 0
}
...
const file_contract_v1_contract_proto_rawDesc = "" +
	...
	"\x18reviewed_at_unix_seconds\x18\f \x01(\x03R\x15reviewedAtUnixSeconds\"\xd7\x03\n" +
	"\tAmendment\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x1f\n" +
	"\vcontract_id\x18\x02 \x01(\x03R\n" +
	"contractId\x12\x1f\n" +
	...
	"\rresponse_note\x18\v \x01(\tR\fresponseNote\"d\n" +
	"\x12CompensationChange\x12&\n" +
	"\x0fnew_hourly_rate\x18\x01 \x01(\x01R\rnewHourlyRate\x12&\n" +
	"\x0fnew_fixed_total\x18\x02 \x01(\x01R\rnewFixedTotal\"J\n" +
	...
	"\fscope_change\x18\x04 \x01(\v2\x18.contract.v1.ScopeChangeR\vscopeChange\"\xe4\x01\n" +
	...
	"\x17created_at_unix_seconds\x18\x06 \x01(\x03R\x14createdAtUnixSeconds\"\xe8\x06\n" +
	"\bContract\x12\x0e\n" +
	...
	"\x15ended_at_unix_seconds\x18\x15 \x01(\x03R\x12endedAtUnixSeconds\"\x92\x03\n" +
	...
	"\n" +
	"hourly_log\x18\x01 \x01(\v2\x16.contract.v1.HourlyLogR\thourlyLog\"\xc4\x01\n" +
	...
	"\x15CONTRACT_STATUS_ENDED\x10\x06*\x87\x02\n" +
	...
	",MILESTONE_STATUS_APPROVED_PENDING_SETTLEMENT\x10\x06*\x93\x01\n" +
	...
	"\x18AMENDMENT_STATUS_EXPIRED\x10\x042\x83\x10\n" +
	...
	"\x1aApproveMilestoneSubmission\x12..contract.v1.ApproveMilestoneSubmissionRequest\x1a/.contract.v1.ApproveMilestoneSubmissionResponse\x12n\n" +
...
var file_contract_v1_contract_proto_msgTypes = make([]protoimpl.MessageInfo, 52)
var file_contract_v1_contract_proto_goTypes = []any{
	...
	(*CompensationChange)(nil),                 // 8: contract.v1.CompensationChange
	(*MilestonesChange)(nil),                   // 9: contract.v1.MilestonesChange
	(*WeeklyLimitChange)(nil),                  // 10: contract.v1.WeeklyLimitChange
	(*ScopeChange)(nil),                        // 11: contract.v1.ScopeChange
	(*AmendmentPayload)(nil),                   // 12: contract.v1.AmendmentPayload
	(*StatusHistoryEntry)(nil),                 // 13: contract.v1.StatusHistoryEntry
	(*Contract)(nil),                           // 14: contract.v1.Contract
	(*CreateContractRequest)(nil),              // 15: contract.v1.CreateContractRequest
	(*CreateContractResponse)(nil),             // 16: contract.v1.CreateContractResponse
	(*GetContractRequest)(nil),                 // 17: contract.v1.GetContractRequest
	(*GetContractResponse)(nil),                // 18: contract.v1.GetContractResponse
	(*ListMyContractsRequest)(nil),             // 19: contract.v1.ListMyContractsRequest
	(*ListMyContractsResponse)(nil),            // 20: contract.v1.ListMyContractsResponse
	(*GetJobOfferStateRequest)(nil),            // 21: contract.v1.GetJobOfferStateRequest
	(*GetJobOfferStateResponse)(nil),           // 22: contract.v1.GetJobOfferStateResponse
	(*AcceptContractRequest)(nil),              // 23: contract.v1.AcceptContractRequest
	(*AcceptContractResponse)(nil),             // 24: contract.v1.AcceptContractResponse
	(*DeclineContractRequest)(nil),             // 25: contract.v1.DeclineContractRequest
	(*DeclineContractResponse)(nil),            // 26: contract.v1.DeclineContractResponse
	(*RevokeContractOfferRequest)(nil),         // 27: contract.v1.RevokeContractOfferRequest
	(*RevokeContractOfferResponse)(nil),        // 28: contract.v1.RevokeContractOfferResponse
	(*SubmitMilestoneWorkRequest)(nil),         // 29: contract.v1.SubmitMilestoneWorkRequest
	(*SubmitMilestoneWorkResponse)(nil),        // 30: contract.v1.SubmitMilestoneWorkResponse
	(*RequestMilestoneChangesRequest)(nil),     // 31: contract.v1.RequestMilestoneChangesRequest
	(*RequestMilestoneChangesResponse)(nil),    // 32: contract.v1.RequestMilestoneChangesResponse
	(*ApproveMilestoneSubmissionRequest)(nil),  // 33: contract.v1.ApproveMilestoneSubmissionRequest
	(*ApproveMilestoneSubmissionResponse)(nil), // 34: contract.v1.ApproveMilestoneSubmissionResponse
	(*UpdateMilestoneStatusRequest)(nil),       // 35: contract.v1.UpdateMilestoneStatusRequest
	(*UpdateMilestoneStatusResponse)(nil),      // 36: contract.v1.UpdateMilestoneStatusResponse
	(*LogHourlyWorkRequest)(nil),               // 37: contract.v1.LogHourlyWorkRequest
	(*LogHourlyWorkResponse)(nil),              // 38: contract.v1.LogHourlyWorkResponse
	(*ListHourlyLogsRequest)(nil),              // 39: contract.v1.ListHourlyLogsRequest
	(*ListHourlyLogsResponse)(nil),             // 40: contract.v1.ListHourlyLogsResponse
	(*ReviewHourlyLogRequest)(nil),             // 41: contract.v1.ReviewHourlyLogRequest
	(*ReviewHourlyLogResponse)(nil),            // 42: contract.v1.ReviewHourlyLogResponse
	(*ProposeAmendmentRequest)(nil),            // 43: contract.v1.ProposeAmendmentRequest
	(*ProposeAmendmentResponse)(nil),           // 44: contract.v1.ProposeAmendmentResponse
	(*RespondAmendmentRequest)(nil),            // 45: contract.v1.RespondAmendmentRequest
	(*RespondAmendmentResponse)(nil),           // 46: contract.v1.RespondAmendmentResponse
	(*ListAmendmentsRequest)(nil),              // 47: contract.v1.ListAmendmentsRequest
	(*ListAmendmentsResponse)(nil),             // 48: contract.v1.ListAmendmentsResponse
	(*PauseContractRequest)(nil),               // 49: contract.v1.PauseContractRequest
	(*PauseContractResponse)(nil),              // 50: contract.v1.PauseContractResponse
	(*ResumeContractRequest)(nil),              // 51: contract.v1.ResumeContractRequest
	(*ResumeContractResponse)(nil),             // 52: contract.v1.ResumeContractResponse
	(*EndContractRequest)(nil),                 // 53: contract.v1.EndContractRequest
	(*EndContractResponse)(nil),                // 54: contract.v1.EndContractResponse
	(*GetStatusHistoryRequest)(nil),            // 55: contract.v1.GetStatusHistoryRequest
	(*GetStatusHistoryResponse)(nil),           // 56: contract.v1.GetStatusHistoryResponse
}
var file_contract_v1_contract_proto_depIdxs = []int32{
	...
	12, // 2: contract.v1.Amendment.payload:type_name -> contract.v1.AmendmentPayload
	4,  // 3: contract.v1.Amendment.status:type_name -> contract.v1.AmendmentStatus
	5,  // 4: contract.v1.MilestonesChange.milestones:type_name -> contract.v1.Milestone
	8,  // 5: contract.v1.AmendmentPayload.compensation_change:type_name -> contract.v1.CompensationChange
	9,  // 6: contract.v1.AmendmentPayload.milestones_change:type_name -> contract.v1.MilestonesChange
	10, // 7: contract.v1.AmendmentPayload.weekly_limit_change:type_name -> contract.v1.WeeklyLimitChange
	11, // 8: contract.v1.AmendmentPayload.scope_change:type_name -> contract.v1.ScopeChange
	1,  // 9: contract.v1.StatusHistoryEntry.status:type_name -> contract.v1.ContractStatus
	0,  // 10: contract.v1.Contract.contract_type:type_name -> contract.v1.ContractType
	1,  // 11: contract.v1.Contract.status:type_name -> contract.v1.ContractStatus
	5,  // 12: contract.v1.Contract.milestones:type_name -> contract.v1.Milestone
	0,  // 13: contract.v1.CreateContractRequest.contract_type:type_name -> contract.v1.ContractType
	5,  // 14: contract.v1.CreateContractRequest.milestones:type_name -> contract.v1.Milestone
	14, // 15: contract.v1.CreateContractResponse.contract:type_name -> contract.v1.Contract
	14, // 16: contract.v1.GetContractResponse.contract:type_name -> contract.v1.Contract
	1,  // 17: contract.v1.ListMyContractsRequest.status:type_name -> contract.v1.ContractStatus
	14, // 18: contract.v1.ListMyContractsResponse.contracts:type_name -> contract.v1.Contract
	14, // 19: contract.v1.AcceptContractResponse.contract:type_name -> contract.v1.Contract
	14, // 20: contract.v1.DeclineContractResponse.contract:type_name -> contract.v1.Contract
	14, // 21: contract.v1.RevokeContractOfferResponse.contract:type_name -> contract.v1.Contract
	14, // 22: contract.v1.SubmitMilestoneWorkResponse.contract:type_name -> contract.v1.Contract
	14, // 23: contract.v1.RequestMilestoneChangesResponse.contract:type_name -> contract.v1.Contract
	14, // 24: contract.v1.ApproveMilestoneSubmissionResponse.contract:type_name -> contract.v1.Contract
	2,  // 25: contract.v1.UpdateMilestoneStatusRequest.status:type_name -> contract.v1.MilestoneStatus
	14, // 26: contract.v1.UpdateMilestoneStatusResponse.contract:type_name -> contract.v1.Contract
	6,  // 27: contract.v1.LogHourlyWorkResponse.hourly_log:type_name -> contract.v1.HourlyLog
	6,  // 28: contract.v1.ListHourlyLogsResponse.hourly_logs:type_name -> contract.v1.HourlyLog
	3,  // 29: contract.v1.ReviewHourlyLogRequest.status:type_name -> contract.v1.HourlyLogStatus
	6,  // 30: contract.v1.ReviewHourlyLogResponse.hourly_log:type_name -> contract.v1.HourlyLog
	12, // 31: contract.v1.ProposeAmendmentRequest.payload:type_name -> contract.v1.AmendmentPayload
	7,  // 32: contract.v1.ProposeAmendmentResponse.amendment:type_name -> contract.v1.Amendment
	4,  // 33: contract.v1.RespondAmendmentRequest.status:type_name -> contract.v1.AmendmentStatus
	7,  // 34: contract.v1.RespondAmendmentResponse.amendment:type_name -> contract.v1.Amendment
	7,  // 35: contract.v1.ListAmendmentsResponse.amendments:type_name -> contract.v1.Amendment
	14, // 36: contract.v1.PauseContractResponse.contract:type_name -> contract.v1.Contract
	14, // 37: contract.v1.ResumeContractResponse.contract:type_name -> contract.v1.Contract
	14, // 38: contract.v1.EndContractResponse.contract:type_name -> contract.v1.Contract
	13, // 39: contract.v1.GetStatusHistoryResponse.entries:type_name -> contract.v1.StatusHistoryEntry
	15, // 40: contract.v1.ContractService.CreateContract:input_type -> contract.v1.CreateContractRequest
	17, // 41: contract.v1.ContractService.GetContract:input_type -> contract.v1.GetContractRequest
	19, // 42: contract.v1.ContractService.ListMyContracts:input_type -> contract.v1.ListMyContractsRequest
	21, // 43: contract.v1.ContractService.GetJobOfferState:input_type -> contract.v1.GetJobOfferStateRequest
	23, // 44: contract.v1.ContractService.AcceptContract:input_type -> contract.v1.AcceptContractRequest
	25, // 45: contract.v1.ContractService.DeclineContract:input_type -> contract.v1.DeclineContractRequest
	27, // 46: contract.v1.ContractService.RevokeContractOffer:input_type -> contract.v1.RevokeContractOfferRequest
	29, // 47: contract.v1.ContractService.SubmitMilestoneWork:input_type -> contract.v1.SubmitMilestoneWorkRequest
	31, // 48: contract.v1.ContractService.RequestMilestoneChanges:input_type -> contract.v1.RequestMilestoneChangesRequest
	33, // 49: contract.v1.ContractService.ApproveMilestoneSubmission:input_type -> contract.v1.ApproveMilestoneSubmissionRequest
	35, // 50: contract.v1.ContractService.UpdateMilestoneStatus:input_type -> contract.v1.UpdateMilestoneStatusRequest
	37, // 51: contract.v1.ContractService.LogHourlyWork:input_type -> contract.v1.LogHourlyWorkRequest
	39, // 52: contract.v1.ContractService.ListHourlyLogs:input_type -> contract.v1.ListHourlyLogsRequest
	41, // 53: contract.v1.ContractService.ReviewHourlyLog:input_type -> contract.v1.ReviewHourlyLogRequest
	43, // 54: contract.v1.ContractService.ProposeAmendment:input_type -> contract.v1.ProposeAmendmentRequest
	45, // 55: contract.v1.ContractService.RespondAmendment:input_type -> contract.v1.RespondAmendmentRequest
	47, // 56: contract.v1.ContractService.ListAmendments:input_type -> contract.v1.ListAmendmentsRequest
	49, // 57: contract.v1.ContractService.PauseContract:input_type -> contract.v1.PauseContractRequest
	51, // 58: contract.v1.ContractService.ResumeContract:input_type -> contract.v1.ResumeContractRequest
	53, // 59: contract.v1.ContractService.EndContract:input_type -> contract.v1.EndContractRequest
	55, // 60: contract.v1.ContractService.GetStatusHistory:input_type -> contract.v1.GetStatusHistoryRequest
	16, // 61: contract.v1.ContractService.CreateContract:output_type -> contract.v1.CreateContractResponse
	18, // 62: contract.v1.ContractService.GetContract:output_type -> contract.v1.GetContractResponse
	20, // 63: contract.v1.ContractService.ListMyContracts:output_type -> contract.v1.ListMyContractsResponse
	22, // 64: contract.v1.ContractService.GetJobOfferState:output_type -> contract.v1.GetJobOfferStateResponse
	24, // 65: contract.v1.ContractService.AcceptContract:output_type -> contract.v1.AcceptContractResponse
	26, // 66: contract.v1.ContractService.DeclineContract:output_type -> contract.v1.DeclineContractResponse
	28, // 67: contract.v1.ContractService.RevokeContractOffer:output_type -> contract.v1.RevokeContractOfferResponse
	30, // 68: contract.v1.ContractService.SubmitMilestoneWork:output_type -> contract.v1.SubmitMilestoneWorkResponse
	32, // 69: contract.v1.ContractService.RequestMilestoneChanges:output_type -> contract.v1.RequestMilestoneChangesResponse
	34, // 70: contract.v1.ContractService.ApproveMilestoneSubmission:output_type -> contract.v1.ApproveMilestoneSubmissionResponse
	36, // 71: contract.v1.ContractService.UpdateMilestoneStatus:output_type -> contract.v1.UpdateMilestoneStatusResponse
	38, // 72: contract.v1.ContractService.LogHourlyWork:output_type -> contract.v1.LogHourlyWorkResponse
	40, // 73: contract.v1.ContractService.ListHourlyLogs:output_type -> contract.v1.ListHourlyLogsResponse
	42, // 74: contract.v1.ContractService.ReviewHourlyLog:output_type -> contract.v1.ReviewHourlyLogResponse
	44, // 75: contract.v1.ContractService.ProposeAmendment:output_type -> contract.v1.ProposeAmendmentResponse
	46, // 76: contract.v1.ContractService.RespondAmendment:output_type -> contract.v1.RespondAmendmentResponse
	48, // 77: contract.v1.ContractService.ListAmendments:output_type -> contract.v1.ListAmendmentsResponse
	50, // 78: contract.v1.ContractService.PauseContract:output_type -> contract.v1.PauseContractResponse
	52, // 79: contract.v1.ContractService.ResumeContract:output_type -> contract.v1.ResumeContractResponse
	54, // 80: contract.v1.ContractService.EndContract:output_type -> contract.v1.EndContractResponse
	56, // 81: contract.v1.ContractService.GetStatusHistory:output_type -> contract.v1.GetStatusHistoryResponse
