...
func (x *HourlyInvoice) GetHourlyRate() float64 {
	if x != nil {
		return x.HourlyRate
	}
	return 0
...
type GetHourlyWorkSummaryResponse struct {
	...
	EstimatedBillableAmount float64                `protobuf:"fixed64,11,opt,name=estimated_billable_amount,json=estimatedBillableAmount,proto3" json:"estimated_billable_amount,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *GetHourlyWorkSummaryResponse) GetHourlyRate() float64 {
	if x != nil {
		return x.HourlyRate
	}
	return 0
...
func (x *GetHourlyWorkSummaryResponse) GetEstimatedBillableAmount() float64 {
	if x != nil {
		return x.EstimatedBillableAmount
	}
	return 0
}
...
const file_contract_v1_contract_proto_rawDesc = "" +
	...
	"\n" +
	"invoice_id\x18\r \x01(\x03R\tinvoiceId\"\xc5\x05\n" +
	...
	"\x10billable_minutes\x18\b \x01(\x05R\x0fbillableMinutes\x12\x1f\n" +
	...
	"\fmilestone_id\x18\b \x01(\x03R\vmilestoneId\"\xe8\x06\n" +
	"\bContract\x12\x0e\n" +
	...
	"\vcontract_id\x18\x01 \x01(\x03R\n" +
	"contractId\x125\n" +
	"\x17week_start_unix_seconds\x18\x02 \x01(\x03R\x14weekStartUnixSeconds\"\x89\x04\n" +
	...
	"\x11remaining_minutes\x18\t \x01(\x05R\x10remainingMinutes\x12\x1f\n" +
	"\vhourly_rate\x18\n" +
	" \x01(\x01R\n" +
	"hourlyRate\x12:\n" +
	"\x19estimated_billable_amount\x18\v \x01(\x01R\x17estimatedBillableAmount\"\x93\x01\n" +
